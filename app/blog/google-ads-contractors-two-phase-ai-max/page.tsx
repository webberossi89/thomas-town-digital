...
export default function Article() {
  return (
    <ArticleLayout meta={meta}>
      ...
      <h2>Why Most Google Ads Campaigns for Contractors Fail</h2>
      <p>
      ...
      <p>
        The most common mistake: launching broad match or AI Max campaigns without any conversion data foundation. Google&apos;s machine learning interprets &ldquo;homeowner calling for HVAC repair&rdquo; and &ldquo;curious person Googling HVAC costs&rdquo; as similar signals until you teach it the difference. And you can only teach it with real data from real conversions.
      </p>
      <p>
      ...
      <h2>Phase 1: Exact Match Keywords Only (Weeks 1–6)</h2>
      <p>
      ...
      <ul>
        <li><strong>Service + location:</strong> [roofing contractor Charlotte], [plumber near me], [HVAC company Denver]</li>
        <li><strong>Emergency intent:</strong> [emergency roof repair], [burst pipe plumber], [AC not working repair]</li>
        <li><strong>Transactional modifiers:</strong> [roof replacement cost], [water heater installation], [HVAC tune-up service]</li>
      </ul>
      <p>
      ...
      <blockquote>
        <p>Phase 1 is about precision. You&apos;re not trying to capture all the volume. You&apos;re building the data layer that makes Phase 2 possible.</p>
      </blockquote>

      <h2>Phase 2: Launch an AI Max Campaign at Half Budget</h2>
      <p>
      ...
      <ul>
        <li>Identify adjacent search terms that buyers actually use (not just what you thought to target)</li>
        <li>Discover phrasing variations that correlate with high-quality leads</li>
        <li>Optimize bids based on the buyer patterns already established in Phase 1</li>
        <li>Expand reach into searches that have similar behavioral profiles to your best converting keywords</li>
      </ul>
      <p>
      ...
      <ul>
        <li>Defined geographic service areas (not trying to rank nationally)</li>
        <li>Phone-based sales processes (calls, not form fills, are the primary conversion)</li>
        <li>Monthly budgets of at least $2,000–$3,000 in ad spend to generate sufficient conversion volume in Phase 1</li>
        <li>Businesses that have tried Google Ads before with inconsistent results</li>
      </ul>
      <p>
