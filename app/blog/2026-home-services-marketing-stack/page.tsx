...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.thomastowndigital.com/blog/2026-home-services-marketing-stack",
...
export default function Article() {
  return (
    <ArticleLayout meta={meta}>
      ...
      <h2>Layer 1: Local SEO and Google Business Profile</h2>
      <p>
      ...
      <ul>
        <li>Business categories that precisely match your core services — primary category matters most</li>
        <li>Service areas that reflect where you actually want to work (not the entire state)</li>
        <li>Accurate, updated business hours including emergency availability</li>
        <li>Regular photo uploads: your trucks, your team, your actual completed jobs</li>
        <li>A steady stream of new reviews — recency matters as much as total count</li>
        <li>Responses to every review, positive and negative, within 24 hours</li>
        <li>Regular Google Posts with offers, updates, and service information</li>
      </ul>
      <p>
      ...
      <h2>Layer 2: Local Services Ads</h2>
      <p>
      ...
      <ul>
        <li><strong>Pay per lead, not per click.</strong> You don&apos;t pay for curiosity. You pay for contact.</li>
        <li><strong>Listings appear organic.</strong> The format looks more like a recommendation than an ad — and homeowners in a stressful situation respond to that.</li>
        <li><strong>Google Guaranteed builds trust.</strong> Verification creates a filter that separates vetted businesses from unverified ones. Homeowners notice.</li>
        <li><strong>Rankings are trust-based, not just bid-based.</strong> A well-optimized business with strong reviews can outrank a higher-spending competitor who hasn&apos;t managed their GBP.</li>
      </ul>
      <p>
      ...
      <h2>Layer 3: Google Ads (Paid Search)</h2>
      <p>
      ...
      <h3>Phase 1: Exact match only (weeks 1–6)</h3>
      <p>
      ...
      <h3>Phase 2: AI Max at half budget</h3>
      <p>
      ...
      <ul>
        <li><strong>Roofing and water damage:</strong> CPCs of $50–$150+ in major metros. Cost per lead typically $300–$500.</li>
        <li><strong>HVAC and plumbing:</strong> CPCs of $20–$40. Cost per lead typically $100–$200.</li>
      </ul>
      <p>
      ...
      <h2>Layer 4: Call Tracking and Pipeline Visibility</h2>
      <p>
      ...
      <ul>
        <li>Which channel drove each call (LSA, Google Ads, organic, direct)</li>
        <li>Which keyword or search term triggered the paid clicks</li>
        <li>Whether the call converted to a booked appointment or job</li>
        <li>Cost per acquired customer by channel</li>
      </ul>
      <p>
      ...
      <ul>
        <li>A strong GBP improves LSA placement and organic map pack ranking</li>
        <li>More reviews and better GBP health lowers LSA cost per lead</li>
        <li>Google Ads fills the gaps LSA doesn&apos;t cover — commercial, specific geographies, brand protection</li>
        <li>AI Max in Phase 2 builds on exact match conversion data to scale efficiently</li>
        <li>Call tracking reveals exactly what&apos;s working so you can allocate budget intelligently</li>
      </ul>
      ...
      <ol>
        <li>Build and optimize your Google Business Profile — categories, service areas, reviews, photos</li>
        <li>Make sure your website is mobile-fast and built to convert calls</li>
        <li>Launch LSA with verified credentials and correct budget settings</li>
        <li>Start Google Ads with exact match, high-intent keywords</li>
        <li>Introduce AI Max as a secondary campaign once conversion data exists</li>
        <li>Set up call tracking across all channels and tie it to your CRM</li>
      </ol>
      <p>
