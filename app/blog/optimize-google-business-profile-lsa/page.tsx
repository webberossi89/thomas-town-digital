...
const meta = {
  title: "How to Optimize Your Google Business Profile for Local Services Ads Success",
  description:
    "Your GBP isn't just about map pack rankings anymore — it's your LSA application. One misconfiguration can kill your entire campaign before it starts.",
  category: "LSA",
...
export default function Article() {
  return (
    <ArticleLayout meta={meta}>
      ...
      <h2>Why Your GBP Matters More Than Ever for LSAs</h2>
      <p>
      ...
      <ul>
        ...
        <li>How trustworthy you are (reviews, ratings, response time)</li>
        <li>Whether you&apos;re a legitimate business with a real location</li>
      </ul>
      <p>
      ...
      <h2>The Biggest GBP Mistake Killing LSA Performance</h2>
      <p>
        Here&apos;s the mistake I see constantly: home service businesses listing themselves as a &ldquo;service area business&rdquo; instead of having a physical address.
      </p>
      <p>
      ...
      <h2>Step 1: Get Your Business Categories Right</h2>
      <p>
      ...
      <p>
        If you&apos;re a plumber, your primary category should be &ldquo;Plumber.&rdquo; Not &ldquo;Home Improvement Contractor.&rdquo; Not &ldquo;Handyman.&rdquo; Plumber. Google matches your primary category to search intent, and if there&apos;s a mismatch, your LSAs won&apos;t show for the searches you want.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>Click &ldquo;Edit profile&rdquo;</li>
        <li>Set your primary category with precision</li>
        <li>Add relevant secondary categories — only what you genuinely offer</li>
      </ul>

      <h2>Step 2: Define Your Service Areas Correctly</h2>
      <p>
        Two mistakes kill service area configuration:
      </p>
      <ul>
        <li>Listing too many service areas and diluting your LSA budget across geography you can&apos;t serve efficiently</li>
        <li>Listing too few and missing profitable jobs nearby</li>
      </ul>
      <p>
      ...
      <p>
        Be specific. Don&apos;t just put &ldquo;Charlotte&rdquo; if you serve specific suburbs. List each city and zip code individually. Google matches searches to service areas at a granular level — if someone searches &ldquo;plumber in Matthews NC&rdquo; and you only have &ldquo;Charlotte&rdquo; listed, you may not show up.
      </p>

      <h2>Step 3: Build a Review System That Actually Works</h2>
      <p>
      ...
      <ul>
        <li>Ask in person immediately after you finish the job, while the customer is satisfied and still present</li>
        <li>Follow up within 24 hours with a text message containing a direct link to your GBP review page</li>
        <li>Make it frictionless — one click, no login required, no navigating to find the right place</li>
      ...
      <h2>Step 4: Complete Every Section of Your Profile</h2>
      <p>
      ...
      <ul>
        <li><strong>Business hours</strong> — and keep them updated. Wrong hours are a trust signal in the wrong direction.</li>
        <li><strong>Phone number</strong> — use a local number, not an 800 number. Local numbers signal local business.</li>
        <li><strong>Website URL</strong> — make sure it goes to a functioning, mobile-fast site.</li>
        <li><strong>Services list</strong> — be specific. &ldquo;Roof replacement,&rdquo; &ldquo;emergency roof repair,&rdquo; &ldquo;gutter installation&rdquo; — not just &ldquo;roofing.&rdquo;</li>
        <li><strong>Business description</strong> — write for the homeowner, include your key services and service area naturally.</li>
        <li><strong>Photos</strong> — real photos of your trucks, your team, and your actual completed work. Not stock images. Google can tell, and so can homeowners.</li>
      </ul>

      <h2>Step 5: Keep Your GBP Active</h2>
      <p>
      ...
      <h2>The Connection Between GBP and LSA Results</h2>
      <p>
      ...
      <ul>
        <li>Log into your Google Business Profile today</li>
        <li>Confirm you have a physical address listed (not service area only)</li>
        <li>Verify your primary category is precise and correct</li>
        <li>Update your service areas to be specific and accurate</li>
        <li>Fill in any missing sections</li>
        <li>Add real photos of your work and team</li>
        <li>Set up a review request system with a direct link</li>
      </ul>
      <p>
