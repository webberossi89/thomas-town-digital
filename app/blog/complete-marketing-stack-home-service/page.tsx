...
export default function Article() {
  return (
    <ArticleLayout meta={meta}>
      ...
      <h2>Why Sequence Matters More Than Channel Selection</h2>
      <p>
      ...
      <h2>Layer 1: Google Business Profile and Local SEO</h2>
      <p>
      ...
      <ul>
        <li>Whether you qualify for Local Services Ads and how you rank in them</li>
        <li>Where you appear in the Google Maps Pack</li>
        <li>How much trust Google assigns your paid campaigns</li>
        <li>How often your business appears for local &ldquo;near me&rdquo; searches</li>
      </ul>
      <p>
      ...
      <ul>
        <li>Physical address listed (not service area only)</li>
        <li>Primary category precisely matching your core service</li>
        <li>Service areas defined at city and zip code level</li>
        <li>A review generation system producing 3–5 new reviews per month</li>
        <li>Responses to every review within 24 hours</li>
        <li>New photos from actual jobs every month</li>
        <li>At least one Google Post per week</li>
      </ul>
      <p>
      ...
      <ul>
        <li><strong>Water damage and restoration:</strong> Emergency intent + trust concerns make this the highest-performing LSA category consistently</li>
        <li><strong>Plumbing:</strong> Consistent year-round demand, high emergency volume, homeowner trust makes Google Guaranteed highly effective</li>
        <li><strong>HVAC:</strong> Seasonal spikes align well with pay-per-lead economics; response speed during peak periods is critical</li>
        <li><strong>Roofing:</strong> Strong performance where GBP is solid and review count is competitive (50+ minimum)</li>
      </ul>
      <p>
      ...
      <h2>Layer 3: Google Search Ads</h2>
      <p>
      ...
      <h3>Phase 1: Exact match foundation (weeks 1–6)</h3>
      <p>
      ...
      <h3>Phase 2: AI Max expansion</h3>
      <p>
      ...
      <ul>
        <li>Roofing and water damage: $50–$150+ CPC in major metros, $300–$500 cost per lead</li>
        <li>HVAC and plumbing: $20–$40 CPC, $100–$200 cost per lead</li>
      </ul>
      <p>
      ...
      <h2>Layer 4: Call Tracking and Pipeline Attribution</h2>
      <p>
      ...
      <ul>
        <li>The specific channel (LSA, Google Ads, organic, direct)</li>
        <li>The specific campaign and ad group (within paid channels)</li>
        <li>The specific keyword that triggered the ad</li>
        <li>Whether the call resulted in a booked appointment</li>
      </ul>
      <p>
      ...
      <ul>
        <li>Strong GBP → higher LSA placement → lower cost per lead from LSA</li>
        <li>LSA leads → more reviews → stronger GBP → better organic map pack rankings</li>
        <li>Google Ads Phase 1 data → AI Max performance → more efficient paid reach</li>
        <li>Call tracking → reveals highest-ROI channels → smarter budget allocation → lower blended CPL over time</li>
      </ul>
      <p>
      ...
      <h2>The Right Build Order</h2>
      <ol>
        <li>Audit and optimize your Google Business Profile — physical address, correct primary category, accurate service areas</li>
        <li>Build or fix your website — mobile-fast, dedicated landing pages for major service types, click-to-call CTAs</li>
        <li>Set up call tracking before any paid spend</li>
        <li>Launch LSA with verified credentials and correct configuration</li>
        <li>Start Google Ads Phase 1 with exact match, high-intent keywords</li>
        <li>Run Phase 1 for 4–6 weeks to build conversion data</li>
        <li>Launch AI Max as a secondary campaign alongside Phase 1</li>
        <li>Review call tracking data monthly and adjust budget allocation accordingly</li>
      </ol>
      <p>
