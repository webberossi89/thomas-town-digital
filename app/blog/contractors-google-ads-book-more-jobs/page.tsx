...
export default function Article() {
  return (
    <ArticleLayout meta={meta}>
      ...
      <h2>Start With the Right Campaign Structure</h2>
      <p>
      ...
      <ul>
        <li><strong>Emergency / urgent repair:</strong> High urgency, short decision window, price-insensitive. Keywords: [emergency AC repair], [burst pipe plumber tonight], [roof leak repair now].</li>
        <li><strong>Planned service / replacement:</strong> 3–7 day decision window, comparison-shopping behavior, larger ticket. Keywords: [HVAC system replacement cost], [new roof estimate], [water heater replacement].</li>
        <li><strong>Specific service campaigns:</strong> Separate targeting for high-value services like water heater installation, full roof replacement, or HVAC system installs — where job values justify premium CPCs.</li>
      </ul>
      <p>
      ...
      <h2>Hyper-Local Targeting: The Geography Advantage</h2>
      <p>
      ...
      <ul>
        <li>Target specific zip codes where their best jobs have historically come from</li>
        <li>Bid up on zip codes with high average job values and bid down or exclude areas with poor close rates</li>
        <li>Adjust geographic radius based on job type — emergency calls justify wider radius; scheduled installs need tighter targeting to keep travel time manageable</li>
        <li>Review geographic performance data monthly and continuously refine</li>
      </ul>
      <p>
      ...
      <h2>Landing Pages That Convert Calls, Not Clicks</h2>
      <p>
      ...
      <ul>
        <li><strong>Headline:</strong> Matches the search intent exactly. &ldquo;Emergency HVAC Repair — Same Day Service&rdquo; not &ldquo;Welcome to [Company Name].&rdquo;</li>
        <li><strong>Phone number:</strong> Click-to-call, large, above the fold. The primary CTA.</li>
        <li><strong>Trust signals:</strong> Google rating, years in business, Google Guaranteed badge, license number.</li>
        <li><strong>Single focus:</strong> No navigation menu leading away from the page. One action: call.</li>
        <li><strong>Speed:</strong> Under 2 seconds load time on mobile. Every extra second costs conversion rate.</li>
      </ul>
      <p>
      ...
      <h2>Negative Keywords: The Hidden Budget Lever</h2>
      <p>
      ...
      <ul>
        <li>DIY searches (&ldquo;how to fix my own furnace,&rdquo; &ldquo;roof repair DIY guide&rdquo;)</li>
        <li>Job seekers (&ldquo;HVAC technician jobs,&rdquo; &ldquo;roofing jobs near me&rdquo;)</li>
        <li>Wrong geography (searches from areas you don&apos;t serve)</li>
        <li>Low-value services you don&apos;t want (&ldquo;furnace cleaning,&rdquo; &ldquo;roof inspection free&rdquo;)</li>
        <li>Competitor brand names you&apos;re not targeting intentionally</li>
      </ul>
      <p>
      ...
      <h2>The Role of Call Tracking in Closing the Loop</h2>
      <p>
      ...
      <ul>
        <li>Campaign 1: Emergency Repair — exact match keywords, aggressive bids, emergency-focused landing page, $1,500/month budget</li>
        <li>Campaign 2: System Replacement — exact match keywords, moderate bids, replacement-focused landing page, $1,200/month budget</li>
        <li>Campaign 3: Tune-up / Seasonal — lower bids, seasonal scheduling, maintenance-focused page, $300/month budget</li>
        <li>LSA running alongside all three: $800–$1,000/month budget for pay-per-lead placement at top of search</li>
      </ul>
      <p>
      ...
      <h2>The Difference Between Contractors Who Win and Those Who Don&apos;t</h2>
      <p>
